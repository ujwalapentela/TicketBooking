   ...
   /* @MockBean
    ...
    void shouldGetAllBookingDetails() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/bookings/allBookings"))
                ...
                .andExpect(jsonPath("$[0].userId.email").value(u1.getEmail()))
                .andExpect(jsonPath("$[0].sectionId.id").value(s1.getId()))
                .andExpect(jsonPath("$[0].seat").value(1))
                .andExpect(jsonPath("$[1].id").value(2))
                .andExpect(jsonPath("$[1].userId.email").value(u3.getEmail()))
                .andExpect(jsonPath("$[1].sectionId.id").value(s2.getId()))
